    ...
    <main className="main-content">
      <div className="page-wrap">
        ...
        <div className="card" style={{ overflow: "hidden", marginBottom: "20px" }}>
          <div style={{ padding: "16px 18px", borderBottom: "1px solid var(--border)", display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "10px" }}>
            <div>
              ...
              <p style={{ fontSize: "11px", color: "var(--text-3)" }}>Platform-wide income vs expenses over time</p>
            </div>
            ...
            <table className="tbl" style={{ minWidth: "600px" }}>
                  ...
                  return (
                    <tr key={t.month}>
                      ...
                      <td style={{ textAlign:"center" }}>
                        {i===0 ? <Minus size={12} color="var(--text-3)" />
                          : change>0 ? <TrendingUp size={12} color="var(--text-2)" />
                          : change<0 ? <TrendingDown size={12} color="#ff8080" />
                          : <Minus size={12} color="var(--text-3)" />}
                      </td>
                    </tr>
                  );
                })}
              ...
              <tfoot>
                <tr style={{ borderTop:"2px solid var(--border-2)" }}>
                  ...
                  <td style={{ textAlign:"right", fontWeight:"600", padding:"11px 14px", color:"var(--text-2)" }}>{fmt(trend.reduce((s,t)=>s+t.expenses,0))}</td>
            ...
            {(["active","moderate","low"] as const).map(level => {
              ...
              return (
                <div key={level} style={{ display:"flex", alignItems:"center", gap:"8px", marginBottom:"10px" }}>
                  ...
                  <span style={{ fontSize:"11px", color:"var(--text-3)", width:"18px", textAlign:"right" }}>{count}</span>
                </div>
              );
            })}
        ...
        <div className="card" style={{ padding: "18px 20px" }}>
          ...
          <p style={{ color: "var(--text-3)", fontSize: "13px", marginBottom: "16px" }}>Download CSV files. Exports respect current filters.</p>
