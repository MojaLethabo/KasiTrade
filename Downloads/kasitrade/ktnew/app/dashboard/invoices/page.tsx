  ...
  return (
    <div className="card" style={{ overflow: "hidden" }}>
      ...
      <div style={{ padding: "18px" }}>
        {quotations.length > 0 && (
          <div style={{ marginBottom: "18px", padding: "12px 14px", background: "var(--surface-2)", border: "1px solid var(--border-2)", borderRadius: "6px" }}>
        ...
        {lines.map(line => (
          <div key={line.id} className="line-item-row">
            <div style={{ position: "relative", gridColumn: "1 / -1" }}>
              ...
              {picker === line.id && (
                <div style={{ position: "absolute", top: "calc(100%+3px)", left: 0, right: 0, background: "var(--surface-2)", border: "1px solid var(--border-2)", borderRadius: "6px", zIndex: 30, maxHeight: "200px", overflowY: "auto", boxShadow: "0 8px 24px rgba(0,0,0,0.4)" }}>
      ...
      <div className="page-wrap">
        <div className="page-header">
          <div>
            ...
            <p style={{ color: "var(--ink-3)", fontSize: "13px" }}>{invoices.length} invoice{invoices.length !== 1 ? "s" : ""}</p>
          </div>
          {!showNew && (
        ...
        {invoices.length === 0 && !showNew ? (
          <div className="card" style={{ padding: "40px", textAlign: "center" }}>
            <p style={{ color: "var(--ink-3)", marginBottom: "14px" }}>No invoices yet.</p>
                ...
                <div key={inv.id} className="card" style={{ border: overdue ? "1px solid rgba(255,80,80,0.3)" : undefined, overflow: "hidden" }}>
                  <div style={{ padding: "14px 18px" }}>
                    <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", alignItems: "flex-start", justifyContent: "space-between" }}>
                      <div style={{ minWidth: 0 }}>
                        <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", alignItems: "center", marginBottom: "4px" }}>
                          ...
                          {hasSent  && <span style={{ fontSize: "10px", color: "var(--ink-3)", fontWeight: "600" }}>✓ Sent</span>}
                        </div>
                      ...
                      <div style={{ textAlign: "right", flexShrink: 0 }}>
                        ...
                        {inv.paidAmount > 0 && inv.status !== "paid" && <div style={{ fontSize: "11px", color: "var(--ink-3)" }}>Paid: {fmt(inv.paidAmount)}</div>}
                      </div>
                    </div>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", marginTop: "12px" }}>
                      ...
                      {sending === inv.id ? (
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", padding: "6px 12px", background: "var(--surface-2)", border: "1px solid var(--border-2)", borderRadius: "6px", flexWrap: "wrap" }}>
                          <Mail size={12} color="var(--ink-3)" />
                          <span style={{ fontSize: "12px", color: "var(--ink-2)" }}>Send to {cust?.email || "client"}?</span>
