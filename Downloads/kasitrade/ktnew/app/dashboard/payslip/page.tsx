...
function PayslipInner() {
  ...
  const [form, setForm] = useState({
    employeeName: sp.get("name") || "",
    idNumber:     sp.get("id")   || "",
    role:         sp.get("role") || "",
    employeeNumber: sp.get("empNum") || "",
    bankName:     sp.get("bank") || "",
    accountNumber: sp.get("acc") || "",
    payMonth: String(new Date().getMonth()),
    payYear:  String(new Date().getFullYear()),
    basicSalary: sp.get("salary") || "",
    ...
    <main className="main-content">
      <div className="page-wrap">
        <div style={{ marginBottom:"24px" }}>
          ...
          <p style={{ color:"var(--ink-3)", fontSize:"13px" }}>Fill in employee details to generate a professional payslip.</p>
        </div>
...
export default function PayslipPage() {
  return (
    <Suspense fallback={<main className="main-content"><p style={{color:"var(--ink-3)",padding:"40px"}}>Loading...</p></main>}>
      <PayslipInner />
    </Suspense>
  );
}
