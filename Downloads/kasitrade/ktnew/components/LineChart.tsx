  ...
  return (
    <div style={{ width: "100%", overflowX: "auto" }}>
      ...
      >
        ...
        {/* Legend */}
        <g>
          <circle cx={PAD.left + 4} cy={PAD.top - 6} r="4" fill="var(--ink)" />
          <text x={PAD.left + 13} y={PAD.top - 2} fontSize="10" fill="var(--ink-3)">Income</text>
          <circle cx={PAD.left + 70} cy={PAD.top - 6} r="3" fill="rgba(255,100,100,0.55)" />
          <text x={PAD.left + 79} y={PAD.top - 2} fontSize="10" fill="var(--ink-3)">Expenses</text>
        </g>
      </svg>
    </div>
  );
